...
% names
video_name='80m.mp4';    % file name
plot1title='Y Mean for Selected Region of Interest at 80 m';

% cut off thresholds for pulse detection
high_thresh = 0.58;
lower_thresh = 0.42;

% initialize the preamble (processor sometimes misses first pulse)
preamble_align = [0 1]
